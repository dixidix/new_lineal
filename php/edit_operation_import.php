...
if(empty($errors)){
	...
	if(!empty($_POST['owner'])){
		MysqliDB::getInstance()->query("UPDATE `operation` SET `ref_client`='".$ref_client."', `operation_number`='".$operation_number."',`merchandise`='".$merchandise."',`transport`='".$transport."',`shipment_origin`='".$shipment_origin."',`estimated_arrival`='".$estimated_arrival."',`custom_document`='".$custom_doc."',`custom_document_djai`='".$custom_doc_djai."',`arrival_date`='".$arrival_date."',`release_date`='".$release_date."',`funding_request_date`='".$request_funding."',`recived_funds_date`='".$recived_funds."',`expired_simi`='".$expired_simi."',`lsl_bill`='".$lsl_bill."',`owner`='".$owner."',`operation_state`='".$op_state."' WHERE `ref_lsl` = '".$ref_lsl."'");
	} else {
		MysqliDB::getInstance()->query("UPDATE `operation` SET `ref_client`='".$ref_client."', `operation_number`='".$operation_number."',`merchandise`='".$merchandise."',`transport`='".$transport."',`shipment_origin`='".$shipment_origin."',`estimated_arrival`='".$estimated_arrival."',`custom_document`='".$custom_doc."',`custom_document_djai`='".$custom_doc_djai."',`arrival_date`='".$arrival_date."',`release_date`='".$release_date."',`funding_request_date`='".$request_funding."',`recived_funds_date`='".$recived_funds."',`expired_simi`='".$expired_simi."',`lsl_bill`='".$lsl_bill."',`operation_state`='".$op_state."' WHERE `ref_lsl` = '".$ref_lsl."'");
	}
}else{
	print_r($errors);
}
